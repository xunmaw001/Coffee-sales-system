  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(31, 147, 255, 0.83);fontSize:28px;">咖啡销售系统注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210218/e6b7a413b4ad421abf7415282b712dc0.jpg");
		height: 100vh;
